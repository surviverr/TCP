...
//判断各种标志位
int syn_packet(char* pkt) {
    return (get_flags(pkt) == SYN);
}

int synack_packet(char* pkt) {
    return (get_flags(pkt) == SYNACK);
}

int ack_packet(char* pkt) {
    return (get_flags(pkt) == ACK);
}

int fin_packet(char* pkt) {
    return (get_flags(pkt) == FIN);
}

int finack_packet(char* pkt) {
    return (get_flags(pkt) == FINACK);
}
