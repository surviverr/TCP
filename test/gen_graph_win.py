...
if len(CWND_dic['utctime']):
    ...
    # plot_win(CWND_dic['time'][:500], np.array(CWND_dic['size'][:500]), 'Congestion', CWND_dic['type'][:500]) # 仅绘制前100个数据点
...
if len(RTTS_dic['utctime']): 
    ...
    # plot_rtt(RTTS_dic['time'][:100], RTTS_dic['SampleRTT'][:100], RTTS_dic['EstimatedRTT'][:100], RTTS_dic['DeviationRTT'][:100], RTTS_dic['TimeoutInterval'][:100])
